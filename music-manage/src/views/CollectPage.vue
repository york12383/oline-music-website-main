...
export default defineComponent({
  ...
  setup() {
    ...
    async function confirm() {
      //const result = (await HttpManager.deleteCollection(proxy.$route.query.id, idx.value)) as ResponseBody;// 原代码
        const result = (await HttpManager.deleteCollection(route.query.id, idx.value)) as ResponseBody;
